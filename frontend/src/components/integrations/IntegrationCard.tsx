    ...
    switch (type) {
      ...
      case 'odoo':
        return [
          ...
          { key: 'api_key', label: 'API Key', type: 'password', placeholder: '••••••••••••••••', helpText: 'From your user profile → Account Security → API Keys', required: true },
        ];
      case 'quickbooks':
        return [
        ...
        return (
          <div className="space-y-3 text-sm">
            ...
            <div className="mt-3 p-2 bg-amber-500/10 border border-amber-500/20 rounded text-xs">
              <strong className="text-amber-600 dark:text-amber-400">⚠️ Important:</strong> Odoo API access requires a <strong>Custom</strong> pricing plan. 
              Free and Standard plans do not include external API access.
            </div>
          </div>
        );
      case 'quickbooks':
